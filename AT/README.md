...
#### 16. O UDP é um protocolo da camada de transporte onde a maior característica é o envio rápido de pacotes, sem muitos atrasos. Forneça o nome de 3 protocolos (ou tecnologias) que façam uso do UDP.
...
#### 29. Quando o assunto é perda/recuperação de dados, qual o risco do proprietário de um celular, ou de uma câmera, quando se vende o aparelho para outra pessoa?
